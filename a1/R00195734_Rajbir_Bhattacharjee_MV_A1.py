...
def get_augmented_point_with_direction(\
    ...
    for k in range(-3, 4):
        for j in range(-3, 4):
            ...
            # In case of the angle being 2pi, this will just
            # overflow and we want to get it back to 0
                ...
                for j in range(-2, 2):
                    ...
                    for k1 in kk1:
                        for k2 in kk2:
                            ...
                            # Since we are subtracting one angle for another
                            # the final result might be negative, keep
                            # adding 2 pi till we get a positive value
                            while theta_st < 0:
                                theta_st += (2 * np.pi)
                            ...
                            # In case of exactly 2*pi, the index will overflow
                            # and we must treat that as 0 (2pi and 0 are same)
